...
| Batch | llama.cpp BF16 | Turbo 12-bit | Speed | Size | VRAM |
|------:|---------------:|-------------:|:-----:|:----:|:----:|
| B=1 | 55.6 tok/s | **62.0 tok/s** | **1.12x** | **1.36x** | **1.35x** |
| B=4 | — | **156.0 tok/s** | — | **1.36x** | **1.35x** |
| **B=8** | — | **162.2 tok/s** | **2.92x** | **1.36x** | **1.35x** |

#### Llama 3.1 8B Instruct (8.03B params, escape rate 0.021%)

| Batch | llama.cpp BF16 | Turbo 12-bit | Speed | Size | VRAM |
|------:|---------------:|-------------:|:-----:|:----:|:----:|
| B=1 | 51.0 tok/s | **58.6 tok/s** | **1.15x** | **1.42x** | **1.43x** |
| B=4 | — | **146.7 tok/s** | — | **1.42x** | **1.43x** |
| **B=8** | — | **159.0 tok/s** | **3.12x** | **1.42x** | **1.43x** |
...
| Batch | llama.cpp BF16 | Turbo 12-bit | Speed | Size | VRAM |
|------:|---------------:|-------------:|:-----:|:----:|:----:|
| B=1 | 33.0 tok/s | **32.6 tok/s** | 0.99x | **1.36x** | **1.41x** |
| B=4 | 50.9 tok/s | **67.0 tok/s** | **1.32x** | **1.36x** | **1.41x** |
| **B=8** | 58.7 tok/s | **80.7 tok/s** | **1.37x** | **1.36x** | **1.41x** |

Speed = faster than llama.cpp BF16. Size = smaller on disk. VRAM = less GPU memory. All 100% lossless.

Llama 3.1 compresses better (1.42x vs 1.36x) due to tighter exponent clustering (0.021% escape rate vs 0.031%).
