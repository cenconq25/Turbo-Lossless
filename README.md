...
| Batch | vLLM BF16 | Turbo 12-bit | vs vLLM | VRAM |
|------:|----------:|-------------:|:-------:|-----:|
| B=1 | 54.7 tok/s | **60.0 tok/s** | **1.10x** | 11.1 GB |
| B=8 | 414.6 | **162.6** | — | 11.1 GB |
| B=32 | 694.2 | **1,136** | **1.64x** | 11.2 GB |
| B=64 | 853 | **1,514** | **1.77x** | 12.7 GB |
| B=128 | 942 | **2,197** | **2.33x** | 12.7 GB |
| B=256 | 872 | **2,554** | **2.93x** | 12.7 GB |

vLLM fills the entire 16 GB card (15.3 GB) and can serve only ~1 user. Turbo serves **256 users at 12.7 GB**.

### Llama 3.1 8B Instruct

| Batch | vLLM BF16 | Turbo 12-bit | VRAM |
|------:|----------:|-------------:|-----:|
| B=1 | OOM | **57.0 tok/s** | 12.4 GB |
| B=8 | OOM | **154.3** | 12.4 GB |
| B=32 | OOM | **1,069** | 12.5 GB |
| B=64 | OOM | **1,439** | 14.0 GB |
| B=128 | OOM | **2,111** | 14.0 GB |
| B=256 | OOM | **2,471** | 14.1 GB |
